...
public:
    ...
    //agrego
    void _alta_recursiva(Clave clave, T dato, NodoDiccionario<Clave, T>* nodo_comparacion);
    ...
    T& buscar_elemento(Clave clave, NodoDiccionario<Clave, T>* nodo);

    T& buscar_elemento(Clave clave);
...
template<typename Clave, typename T>
void Diccionario<Clave, T>::_alta_recursiva(Clave clave, T dato, NodoDiccionario<Clave, T>* nodo_comparacion) {
    ...
    if(clave < nodo_comparacion->obtener_clave()){
        if(!nodo_comparacion->obtener_hijo_izquierdo()){
            ...
            _alta_recursiva(clave, dato, nodo_comparacion->obtener_hijo_izquierdo());
        }
    }else{
        if(!nodo_comparacion->obtener_hijo_derecho()){
            ...
            _alta_recursiva(clave, dato, nodo_comparacion->obtener_hijo_derecho());
        }
    }
}
...
void Diccionario<Clave, T>::alta(Clave clave, T dato) {
    if (cantidad_datos == 0){
        ...
        _alta_recursiva(clave, dato, raiz);
    }
    cantidad_datos++;
}
...
template<typename Clave, typename T>
T& Diccionario<Clave, T>::buscar_elemento(Clave clave, NodoDiccionario<Clave, T>* nodo) {
...
template<typename Clave, typename T>
T& Diccionario<Clave, T>::buscar_elemento(Clave clave) {
    if (raiz == nullptr) {
        throw ExcepcionDiccionario("El diccionario está vacío");
    }
